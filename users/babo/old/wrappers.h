...
#define _________________LOWER_L3__________________        KC_GRAVE, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC
...
#define _________________LOWER_R3__________________        KC_BSLASH, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR


#define _________________RAISE_L1__________________        ________________NUMBER_LEFT________________
#define _________________RAISE_L2__________________        KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BTN1
#define _________________RAISE_L3__________________        KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_BTN2

#define _________________RAISE_R1__________________        ________________NUMBER_RIGHT_______________
#define _________________RAISE_R2__________________        KC_MINS, KC_4,    KC_5,    KC_6,    KC_PLUS
#define _________________RAISE_R3__________________        KC_SLSH, KC_1,    KC_2,    KC_3,    KC_ASTR
